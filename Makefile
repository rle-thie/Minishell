...
#    Updated: 2022/11/11 00:01:05 by rle-thie         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_PARSER = $(addprefix srcs/parsing/, parser.c parsing_input_name.c \
								...
								parser_flags_args.c \
								parser_bool.c \
								parser_redir.c parser_redir_utils.c parser_redir_lst.c parser_redir_clean.c delete_chevron.c parser_heredoc.c)
